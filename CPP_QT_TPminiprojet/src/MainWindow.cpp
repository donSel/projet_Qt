...
//    this->centralWidget()->setStyleSheet("border-image:url('../img/belle.jpg') 0 0 0 0 stretch stretch;");
//    this->centralWidget()->setStyleSheet("border-image:url('../img/montagne.png') 0 0 0 0 stretch stretch;");
